...
namespace Ooorm.Data
{
    ...
    {        
        Task CreateTable<T, TId>() where T : IDbItem<T, TId> where TId : struct, IEquatable<TId>;
        Task CreateTables(params Type[] tables);
        Task DropTable<T, TId>() where T : IDbItem<T, TId> where TId : struct, IEquatable<TId>;
