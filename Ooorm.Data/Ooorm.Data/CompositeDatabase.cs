...
namespace Ooorm.Data
{
    public class CompositeDatabase : IDatabase
    {
        ...
        public async Task CreateTable<T, TId>() where T : IDbItem<TId> where TId : struct, IEquatable<TId>
        {
        ...
        public async Task<int> Delete<T, TId>(params T[] values) where T : IDbItem<TId> where TId : struct, IEquatable<TId>
        {
            if (backTypes.Contains(typeof(T)))
        ...
        public async Task<int> Delete<T, TId>(Expression<Func<T, bool>> predicate) where T : IDbItem<TId> where TId : struct, IEquatable<TId>
        {
            if (backTypes.Contains(typeof(T)))
        ...
        public async Task<int> Delete<T, TParam, TId>(Expression<Func<T, TParam, bool>> predicate, TParam param) where T : IDbItem<TId> where TId : struct, IEquatable<TId>
        {
            if (backTypes.Contains(typeof(T)))
        ...
        public async Task DropTable<T, TId>() where T : IDbItem<TId> where TId : struct, IEquatable<TId>
        {
            if (backTypes.Contains(typeof(T)))
        ...
        public async Task<int> Update<T, TId>(params T[] values) where T : IDbItem<TId> where TId : struct, IEquatable<TId>
        {
            if (backTypes.Contains(typeof(T)))
        ...
        public async Task<int> Write<T, TId>(params T[] values) where T : IDbItem<TId> where TId : struct, IEquatable<TId>
        {
            if (backTypes.Contains(typeof(T)))
