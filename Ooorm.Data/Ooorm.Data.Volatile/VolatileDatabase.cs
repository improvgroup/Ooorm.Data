...
namespace Ooorm.Data.Volatile
{
    public class VolatileDatabase : IDatabase
    {
        ...
        public Task CreateTable<T>() where T : IDbItem<TId> where TId : struct, IEquatable<TId>
        {
            Repos<T>();
        ...
        public Task DropTable<T>() where T : IDbItem<TId> where TId : struct, IEquatable<TId>
        {
